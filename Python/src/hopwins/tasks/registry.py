...
TASKS: dict[str, TaskDefinition] = {
    ...
    for definition in (
        ...
        TaskDefinition(
            "serial_probe",
            "inspect and save raw serial bytes without protocol parsing",
            True,
            "hopwins.tasks.serial_probe",
        ),
        TaskDefinition(
            "raw_record",
        ...
        TaskDefinition(
            ...
            "compare shared-clock RX timestamps with a physical-time CIR average",
            False,
            "hopwins.tasks.static_timing_analysis",
        ),
        TaskDefinition(
            "spatial_timing_analysis",
            "compare RXTS, full-CIR correlation, and dual-CIR spatial timestamps",
            False,
            "hopwins.tasks.spatial_timing_analysis",
        ),
        TaskDefinition(
            "replay",
