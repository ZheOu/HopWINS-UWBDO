 ...
 *@{
 */
    typedef uint32_t dw_chip_id_e;

#define DWT_DW3000_DEV_ID       UINT32_C(0xDECA0302) //!< DW3000 (non-PDoA) silicon device ID
#define DWT_QM33110_DEV_ID      UINT32_C(0xDECA0304) //!< QM33110 (non-PDoA) silicon device ID
#define DWT_DW3000_PDOA_DEV_ID  UINT32_C(0xDECA0312) //!< DW3000 (with PDoA) silicon device ID
#define DWT_QM33120_PDOA_DEV_ID UINT32_C(0xDECA0314) //!< QM33120 (with PDoA) silicon device ID
...
*@{*/
    typedef uint32_t dwt_int_conf_e;

#define DWT_INT_TIMER1_BIT_MASK   UINT32_C(0x80000000) //!< TIMER1 expiry
#define DWT_INT_TIMER0_BIT_MASK   UINT32_C(0x40000000) //!< TIMER0 expiry
#define DWT_INT_ARFE_BIT_MASK     UINT32_C(0x20000000) //!< Frame filtering error
#define DWT_INT_CPERR_BIT_MASK    UINT32_C(0x10000000) //!< STS quality warning/error
#define DWT_INT_HPDWARN_BIT_MASK  UINT32_C(0x08000000) //!< Half-period warning
#define DWT_INT_RXSTO_BIT_MASK    UINT32_C(0x04000000) //!< SFD timeout
#define DWT_INT_PLL_HILO_BIT_MASK UINT32_C(0x02000000) //!< PLL calibration flag
#define DWT_INT_RCINIT_BIT_MASK   UINT32_C(0x01000000) //!< Device entered IDLE_RC
#define DWT_INT_SPIRDY_BIT_MASK   UINT32_C(0x00800000) //!< SPI ready
#define DWT_INT_RXPTO_BIT_MASK    UINT32_C(0x00200000) //!< Preamble timeout
#define DWT_INT_RXOVRR_BIT_MASK   UINT32_C(0x00100000) //!< RX overrun
#define DWT_INT_VWARN_BIT_MASK    UINT32_C(0x00080000) //!< Brownout detected
#define DWT_INT_CIAERR_BIT_MASK   UINT32_C(0x00040000) //!< CIA error
#define DWT_INT_RXFTO_BIT_MASK    UINT32_C(0x00020000) //!< RX frame wait timeout
#define DWT_INT_RXFSL_BIT_MASK    UINT32_C(0x00010000) //!< Reed-Solomon error
#define DWT_INT_RXFCE_BIT_MASK    UINT32_C(0x00008000) //!< RX frame CRC error
#define DWT_INT_RXFCG_BIT_MASK    UINT32_C(0x00004000) //!< RX frame CRC good
#define DWT_INT_RXFR_BIT_MASK     UINT32_C(0x00002000) //!< RX frame ready
#define DWT_INT_RXPHE_BIT_MASK    UINT32_C(0x00001000) //!< PHY header error
#define DWT_INT_RXPHD_BIT_MASK    UINT32_C(0x00000800) //!< PHY header detected
#define DWT_INT_CIADONE_BIT_MASK  UINT32_C(0x00000400) //!< CIA done
#define DWT_INT_RXSFDD_BIT_MASK   UINT32_C(0x00000200) //!< SFD detected
#define DWT_INT_RXPRD_BIT_MASK    UINT32_C(0x00000100) //!< Preamble detected
#define DWT_INT_TXFRS_BIT_MASK    UINT32_C(0x00000080) //!< Frame sent
#define DWT_INT_TXPHS_BIT_MASK    UINT32_C(0x00000040) //!< Frame PHR sent
#define DWT_INT_TXPRS_BIT_MASK    UINT32_C(0x00000020) //!< Frame preamble sent
#define DWT_INT_TXFRB_BIT_MASK    UINT32_C(0x00000010) //!< Frame transmission begins
#define DWT_INT_AAT_BIT_MASK      UINT32_C(0x00000008) //!< Auto-ACK pending
#define DWT_INT_SPICRCE_BIT_MASK  UINT32_C(0x00000004) //!< SPI CRC error
#define DWT_INT_CP_LOCK_BIT_MASK  UINT32_C(0x00000002) //!< PLL locked
#define DWT_INT_IRQS_BIT_MASK     UINT32_C(0x00000001) //!< Interrupt set
/**@}*/
